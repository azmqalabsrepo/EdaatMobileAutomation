...
//	public final static String Biller_Individualclient_Invoice_cName="//span[@id='select2-CustomerId-container']";
	...
	//Aqarek Application
	public final static String Aquarek_Myrequestmenu = "//android.widget.FrameLayout[@content-desc='طلباتي']/android.widget.FrameLayout/android.widget.ImageView";
	public final static String Aquarek_MobileNotextfield = "//android.widget.EditText[@text='5xx xxx xxx']";
	public final static String Aquarek_SigninBtn = "//android.widget.Button[@text='تسجيل الدخول']";
	public final static String Aquarek_Signin_ErrorMessage = "//android.widget.Toast";
