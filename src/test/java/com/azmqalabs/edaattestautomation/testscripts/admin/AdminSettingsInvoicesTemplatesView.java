...
public class AdminSettingsInvoicesTemplatesView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminInvoiceTemplateView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsInvoicesTemplatesView(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Invoice Template is Veiwed Suceessfull");
	        	Pages.AdminSettingsPage.verfiyViewInvoiceTemplate(testdatamap);
