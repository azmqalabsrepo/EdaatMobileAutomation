...
public class AdminAddCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddCorporateClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminAddCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Add Corporate Client is Suceessful");
	        	Pages.AdminCorporatePage.AddCorporateclient(CorporateName,CRNumber,PersonName,PersonID,MobileNo,Email,ClientRefno);
