...
public class AdminToggleCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminToggleCorporateClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminToggleCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Corporate Active/Deactive is Suceessful");
	        	Pages.AdminCorporatePage.ActivateDactivate(CorporateName,testdatamap);
