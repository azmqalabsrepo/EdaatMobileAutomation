...
public class AdminSystemMagmtSearchCatgory {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSearchTaxes";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtSearchCatgory(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Product Management is Page dispayed Suceessfull");
	        	Pages.AdminSystemMangement.navigateSystemMangementTax();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Product Management Active/Deactivate functionality Is Suceessfull");
	        	Pages.AdminSystemMangement.SearchTaxes(testdatamap);
