...
public class AdminSystemMagmtCategoryGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCategoryGridView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtCategoryGridView(Map<Object, Object> testdatamap){
	    	this.testdatamap=testdatamap;
	        this.TestScriptID=testdatamap.get("TestScriptID").toString();
	        this.sBrowserTestData=testdatamap.get("Browser").toString();
	        this.CategoryName=testdatamap.get("CategoryName").toString();
	    }
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step1 : Verify Admin Application Launched Suceessfully");
	           	Pages.InvokeApplicationPage.launchApplication();	        
	        	Pages.InvokeApplicationPage.Chooseoptions();	
	        	
	        	Log.ReportEvent("INFO", "Step2 : Verify Admin Login is Suceessful");
	        	Pages.AdminLoginPage.LoginToApplication(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify Admin Product Management is Page dispayed Suceessfull");
	        	Pages.AdminSystemMangement.navigateSystemMangementCategory();
	        
	        	Log.ReportEvent("INFO", "Step3 : Verify Admin Corporate Grid view is Suceessful");
	        	Pages.AdminSystemMangement.TableGridview(CategoryName);
	    
	        	Log.ReportEvent("INFO", "Step4 : Admin Logout is Suceessful");
