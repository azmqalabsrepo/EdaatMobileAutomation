...
public class AdminTrackerMgmSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmTrackerBillerMgmSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminTrackerMgmSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step2 : Verify User Able to Register or Sign Up Successfully");
	        	Pages.AdminSignUpPage.AdminRegisterWithNewUserID(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify Admin Login is Suceessfull");
	        	Pages.AdminLoginPage.clickOnBillerLogin();
	        	Pages.AdminLoginPage.LoginToApplication(testdatamap);
	        
	        	Log.ReportEvent("INFO", "Step4 : Naviagate to Not approved Biller Management ");
	        	Pages.AdminSystemMangement.navigateNotApprovedBillerManagement();
	        	
	        	Log.ReportEvent("INFO", "Step5 : Save Biller Details as Tracker");
	        	Pages.AdminNotApprovedBillerManagement.CreateTrackerBill(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step6 : Navigate to tracker management");
	        	Pages.AdminSystemMangement.navigateTrackerBillerManagement();
	        	
	        	Log.ReportEvent("INFO", "Step7 : Verify the search functionality  ");
	        	Pages.AdminTrackerBillerManagementPage.verifySearchTrackerBiller(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step8 : Verify that Total Individual Clients is clickable ");
	        	Pages.AdminTrackerBillerManagementPage.verifyIndividualClientIDClickable();
	        	
	        	Log.ReportEvent("INFO", "Step9: Logout  Suceessful");
