...
public class AdminAddInvoiceCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddInvoiceCoprporateClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminAddInvoiceCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Create Corporate Client Invoice is Suceessfull");
	        	Pages.AdminCorporatePage.CreateCorporateClientInvoice(testdatamap);
