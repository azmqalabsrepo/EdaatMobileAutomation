...
public class AdminSystemMagmtToggleTaxes {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminToggleTaxes";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemMagmtToggleTaxes(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Taxes Management is Page dispayed Suceessful");
	        	Pages.AdminSystemMangement.navigateSystemMangementTax();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Taxes Management Search functionality Is Suceessful");
	        	Pages.AdminSystemMangement.ActivateDactivate(testdatamap);
