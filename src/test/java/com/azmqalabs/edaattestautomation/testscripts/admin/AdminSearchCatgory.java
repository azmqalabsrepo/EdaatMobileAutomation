...
public class AdminSearchCatgory {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSearchCategory";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSearchCatgory(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.SearchCategory(testdatamap);
