...
public class AdminNotApprovedMgmCloseBiller {

	// DECLARATION SECTION
	static String TestDataTab="AdmNotApprBilMgmClose";  
	...
	public AdminNotApprovedMgmCloseBiller(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step4 : Verify to click on close button withoud doing any action by maker ");
			Pages.AdminNotApprovedBillerManagement.VerifyClosedBillerForDeactivate(testdatamap);
			...
			if(record==false) {
				...
				Log.ReportEvent("INFO", "Step8 : Verify to click on close button withoud doing any action by maker ");
				Pages.AdminNotApprovedBillerManagement.VerifyClosedBillerForDeactivate(testdatamap);
			}
