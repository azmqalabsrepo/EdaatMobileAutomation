...
public class AdminSettingsProductManagementAddProdActivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddactivateProd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsProductManagementAddProdActivate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.verifyActivateProductFunctionality(testdatamap);
