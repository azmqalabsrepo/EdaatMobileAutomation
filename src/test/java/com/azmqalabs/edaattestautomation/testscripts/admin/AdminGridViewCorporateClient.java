...
public class AdminGridViewCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminViewCorporateClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminGridViewCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminCorporatePage.TableGridview(CorporateName);
