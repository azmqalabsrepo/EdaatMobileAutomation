...
public class AdminReceivablesExportContact {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableExportContact";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesExportContact(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Export Contact");
	        	Pages.AdminReceivablesExportedbillsPage.verifyExportContact(testdatamap);
