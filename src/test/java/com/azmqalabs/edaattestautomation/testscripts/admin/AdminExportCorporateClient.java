...
public class AdminExportCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminExportCorporateClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminExportCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Exported to Excel link is  Suceessful");
	        	Pages.AdminCorporatePage.Export();
