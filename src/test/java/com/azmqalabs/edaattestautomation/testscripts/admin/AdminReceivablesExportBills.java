...
public class AdminReceivablesExportBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableExportBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesExportBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.naviagteReveiableExportAdmin();
	           	...
	           	Log.ReportEvent("INFO", "Step4 : Verify Export Created");
	        	Pages.AdminReceivablesExportedbillsPage.createExportInvoiceData(testdatamap);
