...
public class AdminApprovedBillersMgmUpdateGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmApprovedBillersMgmUpdateGrid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmUpdateGridView(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step5 : Search Biller and Activate the Biller ");
	        	Pages.AdminNotApprovedBillerManagement.ApproveBiller(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step6 : Navigated to Approve Biller Management ");
	        	Pages.AdminSystemMangement.navigateApprovedBillerManagement();
	        	
	        	Log.ReportEvent("INFO", "Step7 :Verify to update biller account Info  & Verify Grid details view  ");
	        	Pages.AdminApprovedBillerManagement.VerifyApprovedGridViewAndUpdate(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step8: Logout  Suceessful");
