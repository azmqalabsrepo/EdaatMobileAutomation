...
public class AdminSettingsInvoicesTemplatesDelete {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminInvoiceTemplateDelete";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsInvoicesTemplatesDelete(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Invoice Template Page Is Displayed Successfully");
	        	Pages.AdminSettingsPage.navigateTemplate();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Invoice Template is Deleted Suceessful");
	        	Pages.AdminSettingsPage.verfiyDeleteInvoiceTemplate(testdatamap);
