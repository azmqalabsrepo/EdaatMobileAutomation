...
public class AdminMyBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="MyBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminMyBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.naviagteReveiableExportAdmin();
	        	
	           	Log.ReportEvent("INFO", "Step4 : Get valid invoic ID");
	        	Pages.AdminReceivablesExportedbillsPage.getInvoiceDetails(testdatamap);
	                	
	        	Log.ReportEvent("INFO", "Step5 : Logout  Suceessful");
	        	Pages.AdminLoginPage.Logout(EdaatOR.Logout);
	        	
	        	Log.ReportEvent("INFO", "Step6 : Navigate to My Bills");
	        	Pages.MyBillsPage.clickOnMyBillMenu();
	        	
	        	Log.ReportEvent("INFO", "Step7 :Verify to enter valid Invoice Number");
	        	Pages.MyBillsPage.verifyInvalidBillNumberMessage(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step8 : Verify to enter Invalid Invoice Number");
	        	Pages.MyBillsPage.verifyValidBillNumberMessage(testdatamap);
