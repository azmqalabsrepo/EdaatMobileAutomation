...
public class AdminAddInvoicetemplate {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddInvoicesTemplates";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminAddInvoicetemplate(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Search Invoice Template is Suceessful");
	        	Pages.AdminSettingsPage.AddInvoicetemplate(TemplateArabic,TemplateEnglish,InvoiceType);
