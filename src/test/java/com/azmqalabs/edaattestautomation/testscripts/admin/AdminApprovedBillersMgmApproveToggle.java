...
public class AdminApprovedBillersMgmApproveToggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmApprovedBillersMgmToggle";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminApprovedBillersMgmApproveToggle(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step7 :Verfiy that biller account activated after checker approve  ");
	        	Pages.AdminApprovedBillerManagement.verifyApproveBillerChecker(testdatamap);
