...
public class AdminSystemManagementAddTaxes {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddTax";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSystemManagementAddTaxes(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.AddTax(testdatamap);
