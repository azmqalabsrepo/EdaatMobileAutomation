...
public class AdminSettingsInvoicesGridview {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminInvoiceGrid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsInvoicesGridview(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Admin Invoice Template Page Is Displayed Successfully");
	        	Pages.AdminSettingsPage.navigateTemplate();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Admin Invoice Template  Variable is displayed Suceessful");
	        	Pages.AdminSettingsPage.GridView(EdaatOR.Systemmgmt_Approved_Menu,EdaatOR.Systemmgmt_table_approved);
