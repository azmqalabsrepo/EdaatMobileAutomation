...
public class AdminDownloadIDIndividualClient {

	// DECLARATION SECTION
	static String TestDataTab="AdminDownloadIndvidualClient";  
	...
	public AdminDownloadIDIndividualClient(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Download ID is Suceessfull");
			Pages.AdminIndividualClientPage.Download(testdatamap);
