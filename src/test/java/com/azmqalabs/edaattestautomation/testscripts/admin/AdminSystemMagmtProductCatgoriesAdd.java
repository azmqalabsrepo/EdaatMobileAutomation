...
public class AdminSystemMagmtProductCatgoriesAdd{
	
	// DECLARATION SECTION
  static String TestDataTab="AdminAddCategory";  
...
public AdminSystemMagmtProductCatgoriesAdd(Map<Object, Object> testdatamap){
...
public void myTest() throws InterruptedException, Exception{
    try{
    	...
    	Log.ReportEvent("INFO", "Step3 : Verify Product Management is Page dispayed Suceessful");
    	Pages.AdminSystemMangement.navigateSystemMangementCategory();
    	
    	Log.ReportEvent("INFO", "Step4 : Verify Product Management Active/Deactivate functionality Is Suceessful");
    	Pages.AdminSystemMangement.AddCategory(testdatamap);
    	
    	Log.ReportEvent("INFO", "Step5 : Admin Logout is Suceessful");
