...
public class AdminExportIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminExportIndividualClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminExportIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Individual Client Export to excel is Suceessfull");
	        	Pages.AdminIndividualClientPage.Export();
