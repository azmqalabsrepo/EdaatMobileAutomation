...
public class AdminSearchIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSearcgIndividualClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSearchIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Search Individual Client  Is Suceessful");
	        	Pages.AdminIndividualClientPage.AdminSearchIndividualclientall(FullName,NationalID,Refno);
