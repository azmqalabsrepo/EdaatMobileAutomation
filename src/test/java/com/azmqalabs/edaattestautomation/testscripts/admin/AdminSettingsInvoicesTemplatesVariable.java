...
public class AdminSettingsInvoicesTemplatesVariable {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminInvoiceTemplateVariable";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsInvoicesTemplatesVariable(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.verifyInvoiceTemplateVariables(testdatamap);
