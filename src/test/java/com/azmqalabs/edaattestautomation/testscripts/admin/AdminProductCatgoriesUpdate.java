...
public class AdminProductCatgoriesUpdate{
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminProductCatgoriesUpdate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSystemMangement.UpdateCategoryDetails(testdatamap);
