...
public class AdminSettingsProductManagementSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminSearchProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsProductManagementSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Product Management Deleted and Active/Deactivate functionality Is Suceessfull");
	        	Pages.AdminSettingsPage.verifySearchFunctionality(testdatamap);
