...
public class AdminDeleteIndividualClient {

	// DECLARATION SECTION
	static String TestDataTab="AdminDeleteIndividualClient";  
	...
	public AdminDeleteIndividualClient(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			this.Refno="MTBS"+testdatamap.get("ClientRefno").toString();
			...
			Log.ReportEvent("INFO", "Step3 : Verify Individual Client Delete is Suceessful");
			Pages.AdminIndividualClientPage.DeleteIndividualClient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno, ResonforDelete);
