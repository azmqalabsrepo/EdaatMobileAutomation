...
public class AdminSystemMagmtTaxesGridView {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminTaxGridView";  
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Admin Product Management is Page dispayed Suceessful");
	        	Pages.AdminSystemMangement.navigateSystemMangementTax();
	        
	        	Log.ReportEvent("INFO", "Step3 : Verify  Grid view is Dispalyed Suceessfully");
	        	Pages.AdminSystemMangement.TableGridviewTax(TaxName);
