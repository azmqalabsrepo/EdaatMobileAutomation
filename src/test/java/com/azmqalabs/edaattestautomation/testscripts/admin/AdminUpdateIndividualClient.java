...
public class AdminUpdateIndividualClient {

	// DECLARATION SECTION
	static String TestDataTab="AdminUpdateIndividualClient";  
	...
	public AdminUpdateIndividualClient(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Upadate Individual Client is Suceessfull");
			Pages.AdminIndividualClientPage.UpdateIndividualClient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email);
