...
public class AdminReceivablesIDPrintBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableIDPrintBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesIDPrintBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminReceivablesExportedbillsPage.naviagteReveiableExportAdmin();
	         	...
	         	Log.ReportEvent("INFO", "Step4 : Verify Invoice ID and Printd");
	        	Pages.AdminReceivablesExportedbillsPage.verifyInvoiceIDandPrint(testdatamap);
