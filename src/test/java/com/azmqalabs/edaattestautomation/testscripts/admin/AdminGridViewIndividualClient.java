...
public class AdminGridViewIndividualClient {

	// DECLARATION SECTION
	static String TestDataTab="AdminViewIndividualClient";  
	...
	public AdminGridViewIndividualClient(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Table view Individual Client is Suceessfull");
			Pages.AdminIndividualClientPage.TableGridview();
