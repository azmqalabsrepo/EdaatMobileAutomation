...
public class AdminCategoryGridView {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminCategoryGridView(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Corporate Grid view is Suceessful");
