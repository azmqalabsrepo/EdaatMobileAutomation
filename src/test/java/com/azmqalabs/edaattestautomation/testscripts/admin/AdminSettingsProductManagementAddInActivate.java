...
public class AdminSettingsProductManagementAddInActivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminInActiveProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsProductManagementAddInActivate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminSettingsPage.verifyDeActiveProductFunctionality(testdatamap);
