...
public class AdminSettingsProductManagementEditProduct {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminUpdateProducts";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSettingsProductManagementEditProduct(Map<Object, Object> testdatamap){
