...
public class AdminNotApprovedBillersMgmReject {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmNotApprBilMgmReject";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmReject(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.VerifyBillerApprovalIsRejected(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step6 :  Verify to click on close button withoud doing any action by checker ");
	        	Pages.AdminNotApprovedBillerManagement.VerifyBillerApprovalIsClosed(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step7: Logout  Suceessful");
