...
public class AdminAddIndividualClient {

	// DECLARATION SECTION
	static String TestDataTab="AdminAddIndividualClient";  
	...
	public AdminAddIndividualClient(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
		try{
			...
			Log.ReportEvent("INFO", "Step3 : Verify Add Individual Client is Suceessful");
			Pages.AdminIndividualClientPage.AddIndividualclient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno);
