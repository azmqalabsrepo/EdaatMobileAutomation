...
public class AdminNotApprovedBillersMgmInvalidActivation {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdmNotApprBilMgmInvalidActive";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminNotApprovedBillersMgmInvalidActivation(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.AdminNotApprovedBillerManagement.VerifyBillerInavlidActivated(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step6: Logout  Suceessful");
