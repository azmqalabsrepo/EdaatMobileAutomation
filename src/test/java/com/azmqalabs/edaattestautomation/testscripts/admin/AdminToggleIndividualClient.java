...
public class AdminToggleIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminToggleIndividualsClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminToggleIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Activate Deactivate Individual Client is Suceessful");
	        	Pages.AdminIndividualClientPage.ActivateDeactivate(testdatamap);
