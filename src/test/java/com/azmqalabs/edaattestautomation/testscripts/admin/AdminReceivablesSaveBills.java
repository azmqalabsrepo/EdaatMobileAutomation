...
public class AdminReceivablesSaveBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminReceivableSaveBills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminReceivablesSaveBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Main Page is Dislayed");	        	
	           	Pages.AdminReceivablesExportedbillsPage.createSaveInvoiceData(testdatamap);
