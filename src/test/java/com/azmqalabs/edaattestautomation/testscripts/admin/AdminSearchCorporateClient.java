...
public class AdminSearchCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminCorporateSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminSearchCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Corporate Client Search is Suceessful");
	        	Pages.AdminCorporatePage.AdminSearchCorporateclientall(CRNumber,CorporateName,Corporateno);
