...
public class AdminAddInvoiceIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="AdminAddInvoiceIndividualClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public AdminAddInvoiceIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Create Individual Client Invoice is Suceessfull");
	        	Pages.AdminIndividualClientPage.CreateIndividualClientInvoice(testdatamap);
