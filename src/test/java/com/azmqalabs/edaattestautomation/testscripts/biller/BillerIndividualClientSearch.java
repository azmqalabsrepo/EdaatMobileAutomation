...
public class BillerIndividualClientSearch {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerIndividualClientSearch(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Individual Client  Search is Suceessful");
	        	Pages.BillerIndividualClientPage.BillerSearchIndividualclientall(FullName,NationalID,Refno);
