...
public class BillerAddInvoiceIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddInvoiceIndividualClt";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAddInvoiceIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.CreateIndividualClientInvoice(testdatamap);
