...
public class BillerUserGrpMgmSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserGroupMgmSearch";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserGrpMgmSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.searchGroup(testdatamap);
