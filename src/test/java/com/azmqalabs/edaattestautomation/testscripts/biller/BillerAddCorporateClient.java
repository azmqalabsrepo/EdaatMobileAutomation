...
public class BillerAddCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddCorporateClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAddCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.AddCorporateclient(CorporateName,CRNumber,PersonName,PersonID,MobileNo,Email,ClientRefno);
