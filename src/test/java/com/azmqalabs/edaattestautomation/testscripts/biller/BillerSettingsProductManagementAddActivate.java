...
public class BillerSettingsProductManagementAddActivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerActiveProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsProductManagementAddActivate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.verifyActiveProductFunctionality(testdatamap);
