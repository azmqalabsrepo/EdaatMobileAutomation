...
public class BillerUserGrpMgmDelete {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSignUp";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserGrpMgmDelete(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerUserGroupManagementPage.deleteGroup(testdatamap);
