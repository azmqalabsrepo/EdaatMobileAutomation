...
public class BillerExportIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportIndivid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerExportIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Export Individual Client is Suceessfull");
	        	Pages.BillerIndividualClientPage.Export();
