...
public class BillerUpdateIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUpdateIndividualClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUpdateIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.UpdateIndividualClient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email);
