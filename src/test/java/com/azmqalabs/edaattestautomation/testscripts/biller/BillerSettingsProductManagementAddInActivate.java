...
public class BillerSettingsProductManagementAddInActivate {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInActiveProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsProductManagementAddInActivate(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.navigateProduct();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Product Management Active/Deactivate functionality Is Suceessfull");
	        	Pages.BillerSettingsPage.verifyDeActiveProductFunctionality(testdatamap);
