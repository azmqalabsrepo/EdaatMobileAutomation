...
public class BillersystemmanagementDeacttoActMaker {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtDeacttoActMaker";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementDeacttoActMaker(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Account has Been Deactivated by the Checker Suceessfully");
	        	Pages.BillerSystemMangement.DeactoAct(testdatamap);
