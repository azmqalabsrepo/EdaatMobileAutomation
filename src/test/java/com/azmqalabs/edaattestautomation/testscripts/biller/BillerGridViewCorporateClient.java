...
public class BillerGridViewCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerViewCorp";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerGridViewCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.TableGridview(CorporateName);
