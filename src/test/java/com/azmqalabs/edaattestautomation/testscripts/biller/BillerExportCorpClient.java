...
public class BillerExportCorpClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerExportCorp";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerExportCorpClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.Export();
