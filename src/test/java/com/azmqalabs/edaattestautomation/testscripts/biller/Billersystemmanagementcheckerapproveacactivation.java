...
public class Billersystemmanagementcheckerapproveacactivation {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtcheckeracact";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public Billersystemmanagementcheckerapproveacactivation(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Account has been approved by the Checker Suceessfully");
	        	Pages.BillerSystemMangement.ActivatedbyChecker(testdatamap);
