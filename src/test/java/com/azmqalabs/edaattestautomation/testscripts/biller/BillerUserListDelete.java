...
public class BillerUserListDelete {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserListDelete";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserListDelete(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify User Is Deleted Successfully and Verify Deleted Users checkbox");
	        	Pages.BillerUserMngUserListPage.verifyDeleteUser(testdatamap);
