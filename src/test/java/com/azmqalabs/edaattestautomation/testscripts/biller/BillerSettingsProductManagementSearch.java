...
public class BillerSettingsProductManagementSearch {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSearchProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsProductManagementSearch(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.verifySearchFunctionality(testdatamap);
