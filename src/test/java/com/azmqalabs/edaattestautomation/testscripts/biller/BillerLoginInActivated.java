...
public class BillerLoginInActivated {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInactivated";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerLoginInActivated(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(testdatamap.get("BillerUserName").toString(),testdatamap.get("BillerPassword").toString());
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify Main Page is Dislayed");	        	
	           	Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.LoginPage_Error_Invalid);
