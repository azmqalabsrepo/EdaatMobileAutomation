...
public class BillerUserGrpMgmPermissionEdit {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserGroupMgmUpdatePermiss";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserGrpMgmPermissionEdit(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify to view group permission and Verify to edit group permission");
	        	Pages.BillerUserGroupManagementPage.updateAndViewGroupPermission(testdatamap);
