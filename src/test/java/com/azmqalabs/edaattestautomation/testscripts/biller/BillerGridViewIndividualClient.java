...
public class BillerGridViewIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerViewIndivid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerGridViewIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.TableGridview();
