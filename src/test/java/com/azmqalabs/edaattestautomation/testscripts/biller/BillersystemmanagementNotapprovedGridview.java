...
public class BillersystemmanagementNotapprovedGridview {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtNotApproved";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementNotapprovedGridview(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Not Approved Grid view is Loaded Suceessfully");
	        	Pages.BillerSystemMangement.Gridview(EdaatOR.Systemmgmt_NotApproved_Menu,EdaatOR.Systemmgmt_table_approved);
