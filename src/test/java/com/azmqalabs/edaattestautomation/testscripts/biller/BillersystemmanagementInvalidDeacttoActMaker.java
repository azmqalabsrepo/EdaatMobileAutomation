...
public class BillersystemmanagementInvalidDeacttoActMaker {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtInDeactActMaker";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementInvalidDeacttoActMaker(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSystemMangement.DeactoActInvalid(testdatamap);
