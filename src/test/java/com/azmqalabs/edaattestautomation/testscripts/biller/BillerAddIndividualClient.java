...
public class BillerAddIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddIndividualClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAddIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.AddIndividualclient(FullName,SecondName,ThirdName,LastName,NationalID,Year,Month,Date,MobileNo,Email,Refno);
