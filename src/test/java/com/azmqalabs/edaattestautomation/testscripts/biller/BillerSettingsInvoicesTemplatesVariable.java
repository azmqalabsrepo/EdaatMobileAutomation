...
public class BillerSettingsInvoicesTemplatesVariable {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsInvoicesTemplatesVariable(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.navigateTemplate();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Invoice Template is Variable Suceessfull");
	        	Pages.BillerSettingsPage.verfiyInvoiceTemplateVariables(testdatamap);
