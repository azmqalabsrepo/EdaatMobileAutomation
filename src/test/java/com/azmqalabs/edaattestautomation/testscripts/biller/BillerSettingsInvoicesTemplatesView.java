...
public class BillerSettingsInvoicesTemplatesView {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInvoiceTemplateView";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsInvoicesTemplatesView(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerSettingsPage.verfiyViewInvoiceTemplate(testdatamap);
