...
public class BillerAddInvoiceCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddCorpIndividualClt";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerAddInvoiceCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.CreateCorporateClientInvoice(testdatamap);
