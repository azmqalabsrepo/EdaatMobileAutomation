...
public class BillersystemmanagementApprovedGridview {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtApproved";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementApprovedGridview(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Approved Grid view is Loaded Suceessfully");
	        	Pages.BillerSystemMangement.Gridview(EdaatOR.Systemmgmt_Approved_Menu,EdaatOR.Systemmgmt_table_approved);
