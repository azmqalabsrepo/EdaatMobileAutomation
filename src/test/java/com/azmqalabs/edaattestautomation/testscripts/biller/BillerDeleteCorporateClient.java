...
public class BillerDeleteCorporateClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDeleteCorporatelClient";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDeleteCorporateClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Delete Corporate Client is Suceessfull");
	        	Pages.BillerCorporatePage.DeleteCorporateClient(CorporateName,CRNumber,PersonName,PersonID,MobileNo,Email,ClientRefno,ResonforDelete);
