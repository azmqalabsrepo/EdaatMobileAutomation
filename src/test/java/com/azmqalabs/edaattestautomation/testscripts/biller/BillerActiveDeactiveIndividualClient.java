...
public class BillerActiveDeactiveIndividualClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerActivateDeactIndivid";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerActiveDeactiveIndividualClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.ActivateDeactivate();
