...
public class BillersystemmanagementApprovedtoggle {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerSystemMgmtApprovedtoggle";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillersystemmanagementApprovedtoggle(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify  Activate/Deactivate status toggel button working fine  ");
	        	Pages.BillerSystemMangement.Toggle(EdaatOR.Systemmgmt_Approved_Menu,EdaatOR.Systemmgmt_toggle);
