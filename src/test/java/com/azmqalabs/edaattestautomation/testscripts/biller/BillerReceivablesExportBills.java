...
public class BillerReceivablesExportBills {
	
	// DECLARATION SECTION
	  static String TestDataTab="Exportedbills";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerReceivablesExportBills(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerReceivablesExportedbillsPage.naviagteReveiableExportBiller();
	        	
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify Main Page is Dislayed");	        	
	           	Pages.BillerReceivablesExportedbillsPage.createSaveInvoiceData(testdatamap);
	           	
	           	Log.ReportEvent("INFO", "Step5 : Verify Export Created");
	        	Pages.BillerReceivablesExportedbillsPage.createExportInvoiceData(testdatamap);
	        	
	         	Log.ReportEvent("INFO", "Step6 : Verify Invoice ID and Printd");
	        	Pages.BillerReceivablesExportedbillsPage.verifyInvoiceIDandPrint(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step7 : Verify Export Contact");
	        	Pages.BillerReceivablesExportedbillsPage.verifyExportContact(testdatamap);
