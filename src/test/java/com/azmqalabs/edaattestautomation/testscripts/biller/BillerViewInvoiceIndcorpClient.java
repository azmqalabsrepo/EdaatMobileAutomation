...
public class BillerViewInvoiceIndcorpClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerViewInvoiceIndividualClt";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerViewInvoiceIndcorpClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerIndividualClientPage.ViewIndividualClientInvoice(testdatamap);
