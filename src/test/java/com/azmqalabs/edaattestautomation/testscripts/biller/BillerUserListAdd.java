...
public class BillerUserListAdd {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserListAdd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserListAdd(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify to add new user account");
	        	Pages.BillerUserMngUserListPage.verifyAddUser(testdatamap);
