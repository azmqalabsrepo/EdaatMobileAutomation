	...
	public class BillerLoginForgetPassword {
		
		// DECLARATION SECTION
	  static String TestDataTab="BillerLoginforget";  
	...
	public BillerLoginForgetPassword(Map<Object, Object> testdatamap){
	...
	public void myTest() throws InterruptedException, Exception{
	    try{
	    	...
	    	//Actual Test steps
			  ...
			  Log.ReportEvent("INFO","Step2 : Verify Biller Forgetpassword Functionality");
			  Pages.BillerLoginPage.ForgetPassword(EdaatOR.LoginPage_Forgetlink,Username);
			  
			  Log.ReportEvent("INFO","Step3 : Verify Forget Password  Message is Dislayed");
			  Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.LoginPage_confirmation);
