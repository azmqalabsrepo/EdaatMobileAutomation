...
public class BillerInvalidLogin {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInvalidLogin";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerInvalidLogin(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerLoginPage.LoginToApplication(Username,Password);
	        	
	        	Log.ReportEvent("INFO", "Step3 : Verify Main Page is Dislayed");	        	
	           	Pages.BillerLoginPage.ExistsCheckElement(EdaatOR.LoginPage_Error);
