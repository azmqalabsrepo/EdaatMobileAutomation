...
public class BillerActiveDeactiveCorpClient {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerActivateDeactCorp";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerActiveDeactiveCorpClient(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Pages.BillerCorporatePage.ActivateDactivate(CorporateName);
