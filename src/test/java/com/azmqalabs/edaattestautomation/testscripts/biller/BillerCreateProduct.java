...
public class BillerCreateProduct {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerAddProduct";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerCreateProduct(Map<Object, Object> testdatamap){
	    	this.testdatamap=testdatamap;
	        this.TestScriptID=testdatamap.get("TestScriptID").toString();
	        this.sBrowserTestData=testdatamap.get("Browser").toString();
	        this.ProdArabic=testdatamap.get("ProdArabic").toString();
	  	    this.ProdEnglish=testdatamap.get("ProdEnglish").toString();
	  	    this.Category=testdatamap.get("Category").toString();
	  	    this.BasicPrice=testdatamap.get("BasicPrice").toString();
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Add Product is Suceessfull");
	        	Pages.BillerSettingsPage.AddProduct(ProdArabic,ProdEnglish,Category,BasicPrice);
