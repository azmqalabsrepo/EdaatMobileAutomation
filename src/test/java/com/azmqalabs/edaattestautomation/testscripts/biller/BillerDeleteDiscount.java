...
public class BillerDeleteDiscount {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerDiscount";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerDeleteDiscount(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Verify Add and Search Invoice Template is Suceessfull");
	        	Pages.BillerSettingsDiscountPage.navigateDisCountPage();
	        
	        	Log.ReportEvent("INFO", "Step3 : Verify Delete discount Suceessfull");
	        	Pages.BillerSettingsDiscountPage.verifyDeleteDiscount(testdatamap);
