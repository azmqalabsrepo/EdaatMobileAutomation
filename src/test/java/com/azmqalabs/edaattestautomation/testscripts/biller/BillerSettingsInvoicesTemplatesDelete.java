...
public class BillerSettingsInvoicesTemplatesDelete {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerInvoiceTemplateDelete";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerSettingsInvoicesTemplatesDelete(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step4 : Verify Invoice Template is Deleted Suceessfull");
	        	Pages.BillerSettingsPage.verfiyDeleteInvoiceTemplate(testdatamap);
