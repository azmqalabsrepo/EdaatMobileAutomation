...
public class BillerUserGrpMgmAdd {
	
	// DECLARATION SECTION
	  static String TestDataTab="BillerUserGroupMgmAdd";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public BillerUserGrpMgmAdd(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	Log.ReportEvent("INFO", "Step3 : Navigate to Group Management Page");
	        	Pages.BillerUserGroupManagementPage.naviagteGroupManagement();
	        	
	        	Log.ReportEvent("INFO", "Step4 : Verify to add new group");
	        	Pages.BillerUserGroupManagementPage.addGroup(testdatamap);
	        	
	        	Log.ReportEvent("INFO", "Step5 : Navigate to User list Page");
	        	Pages.BillerUserMngUserListPage.navigateUserlistPage();
	        	
	        	Log.ReportEvent("INFO", "Step6 : Verify to view the users under this group ");
	        	Pages.BillerUserGroupManagementPage.verifyViewGroupUnderUserList(testdatamap);
