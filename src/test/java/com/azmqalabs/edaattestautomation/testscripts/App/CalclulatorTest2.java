...
public class CalclulatorTest2 {
	...
	// DECLARATION SECTION
	  ...
	  DBUtil DBUtil;
	    ...
	    public CalclulatorTest2(Map<Object, Object> testdatamap){
	    ...
	    public void myTest() throws InterruptedException, Exception{
	        try{
	        	...
	        	WebElement plus =driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc='plus']"));
	       		WebElement seven = driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc='7']"));
	           	WebElement equal = driver.findElement(By.xpath("//android.widget.ImageButton[@content-desc='equals']"));
	             actions.click(five).build().perform();
	             actions.click(plus).build().perform();
	             actions.click(seven).build().perform();
	             actions.click(equal).build().perform();
	             Thread.sleep(2000);   
