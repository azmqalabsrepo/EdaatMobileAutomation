...
public class Aqarekplatform {
	
	// DECLARATION SECTION
	  static String TestDataTab="AqarekPlatformSignin";  
	  ...
	  DBUtil DBUtil;
	    ...
	    public Aqarekplatform(Map<Object, Object> testdatamap){
...
//	    @Parameters({ "username", "password" })
	    ...
	    public void myTest() throws InterruptedException, Exception{
	       	...
	       	Log.ReportEvent("INFO", "Step1 : Verify Signin Error Message  Suceessful");
        	Pages.AqarekPlatformPage.Signin(testdatamap);;
        	
	       	Log.ReportEvent("INFO", "Step2 : Close app  Suceessful");
        	driver.quit();
        }
